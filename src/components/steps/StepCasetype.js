      ...
      <div className={`ScreenerPage__Case ${show ? "" : "d-none"}`}>
        ...
        {user.nycha ? (
          <div className="ScreenerPage__CaseButtons">
            ...
            <button
              className={`btn btn-default ${
                user.caseType == "termination" ? "active" : ""
              }`}
              onClick={() => this.handleCaseButtonClick("termination")}
            >
              <Trans id="Termination" />
            </button>
            <button
              className={`btn btn-default ${
                user.caseType == "other" ? "active" : ""
              }`}
          ...
          <div className="ScreenerPage__CaseButtons">
            ...
            <button
              className={`btn btn-default ${
                user.caseType == "general" ? "active" : ""
              }`}
              onClick={() => {
                this.setState({ unsure: true });
