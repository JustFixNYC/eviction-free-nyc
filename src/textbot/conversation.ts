 ...
 */
export type ConversationHandler<State> = (
  state: State,
  input: string
 ...
 */
export function deserializeConversationState<State extends Object>(
 ...
 */
export function serializeConversationState<State extends Object>(
  state: State
): string {
